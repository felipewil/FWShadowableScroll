...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of FWShadowableScroll.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'Felipe Leite' => 'felipe.leite.gv@gmail.com' }
  s.source           = { :git => 'https://github.com/Felipe Leite/FWShadowableScroll.git', :tag => s.version.to_s }
